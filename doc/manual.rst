...
::
  ...
  wget https://bitbucket.org/ugoertz/kombilo/downloads/kombilo-0.7.3.tar.gz

  # unpack the archive
  tar xfz kombilo-0.7.3.tar.gz kombilo
...
Download the ``kombilo-0.7.3.tar.gz`` archive from the `Kombilo downloads
